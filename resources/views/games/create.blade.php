...
<div class="container bg-white">
    ...
    <div class="registration-form">
        <form action="{{ route('games.store') }}" method="POST">
            ...
            <div class="form-group mb-4">
                <input type="text" class="form-control item @error('console') is-invalid @enderror" name="console" value="{{old('console')}}" id="email" placeholder="Console">
                @error('console')
                <span class="text-danger ms-2 validation-msg">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group mb-4">
                <input type="text" class="form-control item @error('pegi') is-invalid @enderror" name="pegi" value="{{old('pegi')}}" id="birth-date" placeholder="PEGI">
                @error('pegi')
                <span class="text-danger ms-2 validation-msg">{{ $message }}</span>
                @enderror
            </div>

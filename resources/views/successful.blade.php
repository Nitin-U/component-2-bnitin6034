...
<body>
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mt-5">
        <tr>
            <td align="center">

                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                    <tr>
                        <td align="center" valign="top" style="font-size:0; padding: 35px;" bgcolor="#B71C1C">
                                                    ...
                                                    <td
                                                        ...
                                                        <a href="#" target="_blank"
                                                            style="color: #ffffff; text-decoration: none;"><img
                                                                src="images/emlogo.png" width="50" height="50"
                            ...
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        <h2
                                            style="font-size: 30px; font-weight: 800; line-height: 36px; color: #333333; margin: 0;">
                                            <i class="fa-solid fa-money-bill fa-md me-2"></i>Cash on delivery
                                        </h2>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left"
                                        ...
                                        <p style="font-size: 16px; font-weight: 400; line-height: 24px; color: #777777;"
                                            class="ms-3">
                                            Your order has been placed successfully. We will be delivering your order
                                            promptly.
                                        </p>
                                    </td>
                                </tr>
                                            ...
                                            <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%"
                                                ...
                                                <tr>
                                                    <td align="left" valign="top"
                                                        ...
                                                        <p>Trade Tower<br>3rd Floor<br>Thapathali, Kathmandu
                                                        </p>

                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 col-xl-7 mx-auto">
                            ...
                            <p class="text-muted mb-4">Welcome to Essential Mart! Please enter your credentials.</p>
                            <form method="POST" action="{{ route('login') }}">
                                @csrf
                                ...
                                <button type="submit"
                                    class="btn btn-primary btn-block text-uppercase mb-2 w-100 rounded-pill shadow-sm p-2">{{ __('Login') }}</button>
                            </form>
                        </div>
                    </div>
                </div><!-- End -->
